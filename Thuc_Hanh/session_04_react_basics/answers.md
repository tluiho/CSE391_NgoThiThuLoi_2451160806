...
## Bài 0.2:  
- Bài 1: Tạo file UserProfile.jsx trong hello-react/src/
- Bài 2: Tạo file ProductInfo.jsx trong hello-react/src/

## Bài 1.1: Tạo file LifecycleDemo.jsx trong TIER1/src/
...
## Bài 1.2: Tạo file BadCounter.jsx trong TIER1/src/
...
## Bài 1.3: Tạo file FlowDemo.jsx trong TIER1/src/

## Bài 2.1 2.2 2.3: Tạo các file .jsx trong TIER2/src/

## Tương tụ các bài trong các tier đều tạo các file .jsx trong Tier.../src/ tương ứng.